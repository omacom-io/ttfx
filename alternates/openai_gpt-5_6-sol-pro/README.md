# openai/gpt-5.6-sol-pro — alternate port via retrieval, not context

Generated 37/37 effects (11086 lines, 51.4% of the reference port's surface),
every kept effect gated on **compiles AND emits ANSI-styled animation** — not just
`cargo build`. **$30.2842 all-in vs $43** DHH paid for the same model (beats by 29.6%). Corpus (plan.md + 144 Python files, 396,489 tokens) was
